/**
 * deploy.js — Bhoomi Setu Contract Deployment Script
 * Run: npx hardhat run scripts/deploy.js --network localhost
 * (Start the node first: npx hardhat node)
 */
...
async function main() {
  ...
  // 2. Deploy AssurancePool (oracle = account[1])
  ...
  // 4. Register community members (accounts 2–21 = 20 Dongri Pahad members)
  ...
  // 5. Write deployment addresses to JSON (read by web3_bridge.py)
  const deployments = {
