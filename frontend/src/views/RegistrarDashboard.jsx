...
export default function RegistrarDashboard({ lang, t, apiBase }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Interactive GIS Map Section (When viewMode is 'split') */}
      {viewMode === 'split' && (
      ...
      {/* Grid: Parcel List & Detailed Inspector */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Column: Parcel Table */}
        ...
        <div className="lg:col-span-7 bg-slate-900/80 border border-slate-800 rounded-xl p-5 space-y-5 h-[600px] overflow-y-auto">
          {selectedParcel ? (
            <>
              ...
              {/* Area Reconciliation: Mirror Principle Demonstration */}
              ...
              {/* Priority 2a: Risk-Indexed Premium Formula Breakdown */}
              {selectedParcel.schema_type !== 'community' && (
