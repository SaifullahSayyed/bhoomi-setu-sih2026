...
def run_qa_audit():
    ...
    p_zero["ror_text"] = "खाता संख्या: 999 खसरा संख्या: 999/1 कुल क्षेत्रफल: 15.50 बिघा"                       
    p_zero["mutation_history"] = []                      
    p_zero["owners"] = [{"name": "Balram Sahukar", "id_hash": "benami_shared_hash", "share_fraction": 1.0}]
    p_zero["declared_value_inr"] = 5_000_000                

    p_zero_dup = dict(p_zero)                                  
    ...
    test_cases_prem = [
        ...
        (85, 1_000_000, 1.00, 1000.0),                                                                    
        (95, 1_000_000, 0.50, 500.0),                                                                   
        (100, 2_000_000, 0.25, 500.0),                                                                   
        (80, 1_000_000, 1.25, 1250.0),                                                                    
        (90, 5_000_000, 0.75, 3750.0),                                                                    
    ]
